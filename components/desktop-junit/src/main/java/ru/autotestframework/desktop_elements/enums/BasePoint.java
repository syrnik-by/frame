...
public enum BasePoint {
    ...
    public int getXCoordinate(final int xTopLeftCoordinate, final int width) {
        switch (this) {
            case TOP_LEFT:
            case BOTTOM_LEFT:
            case CENTER_LEFT:
            ...
            default:
                throw new ExecutionException("Wrong BasePoint");
        }
    }

    public int getYCoordinate(final int yTopLeftCoordinate, final int height) {
        switch (this) {
            case TOP_LEFT:
            case TOP_RIGHT:
            case CENTER_TOP:
