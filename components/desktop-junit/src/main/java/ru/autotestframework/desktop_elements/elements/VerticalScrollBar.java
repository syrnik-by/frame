...
public class VerticalScrollBar extends ScrollBarBase {
    ...
    public VerticalScrollBar(final WebElement wrappedElement, final String title) {
    ...
    public void scrollUp() {
        callVoidCommand(VERTICAL_SCROLL_BAR_SCROLL_UP);
    }
    ...
    public void scrollDown() {
        callVoidCommand(VERTICAL_SCROLL_BAR_SCROLL_DOWN);
    }
    ...
    public void scrollUpLarge() {
        callVoidCommand(VERTICAL_SCROLL_BAR_SCROLL_UP_LARGE);
    }
    ...
    public void scrollDownLarge() {
        callVoidCommand(VERTICAL_SCROLL_BAR_SCROLL_DOWN_LARGE);
    }
}
