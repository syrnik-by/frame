...
/**
 * Class to manage options specific to {@link DesktopDriver}.
 */
public class DesktopOptions implements DesktopDriverOptions {
     ...
     */
    public DesktopOptions setApplicationPath(final String applicationPath) {
     ...
     */
    public DesktopOptions setArguments(final String arguments) {
     ...
     */
    public DesktopOptions setConnectToRunningApp(final Boolean connectToRunningApp) {
     ...
     */
    public DesktopOptions setLaunchDelay(final Integer launchDelay) {
     ...
     */
    public DesktopOptions setProcessFindTimeOut(final Integer processFindTimeOut) {
     ...
     */
    public DesktopOptions setProcessName(final String processName) {
     ...
     * Need EXTENDED version of Driver.
     *
     * @param injectionActivate Activate injection technology
     */
    public DesktopOptions setInjectionActivate(final Boolean injectionActivate) {
     ...
     */
    public DesktopOptions setInjectionDllType(final String injectionDllType) {
     ...
     */
    public DesktopOptions setResponseTimeout(final Integer responseTimeout) {
        this.responseTimeout = responseTimeout;
        return this;
    }

    /**
     * Convert options to DesiredCapabilities for Desktop Driver
     *
     * @return The DesiredCapabilities for Desktop Driver with these options.
     */
    @Override
    ...
    private static boolean notNullAndNotEmpty(final String value) {
        return !(value == null || value.isEmpty());
    }

    private static boolean notNull(final Boolean value) {
        return value != null;
    }

    private static boolean notNullAndNotNegative(final Integer value) {
