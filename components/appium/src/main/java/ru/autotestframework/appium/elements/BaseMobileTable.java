...
public class BaseMobileTable extends TypifiedMobileElement implements ITable {
    @Setter
    @Getter
    ...
    public BaseMobileTable(final WebElement element, final String title) {
        super(element, title);
    }

    public BaseMobileTable(
    ...
    /**
     * sets header's and cell's xpathes
     * @param tableElement
     */
