...
public class Rectangle {
     ...
     */
    public Rectangle merge(final Rectangle that) {
        return new Rectangle(
                min(this.getMinPoint().x, that.getMinPoint().x),
     ...
     */
    boolean containsPoint(final Point point) {
    ...
    public boolean equals(final Object o) {
        ...
        return minPoint.equals(rectangle.minPoint) && maxPoint.equals(rectangle.maxPoint);
    }
